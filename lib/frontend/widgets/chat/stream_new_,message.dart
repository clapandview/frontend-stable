...
class StreamNewMessage extends StatefulWidget {
  final String idUser;
  final String idGroup;

  const StreamNewMessage({
  ...
  @override
  _StreamNewMessageState createState() => _StreamNewMessageState();
}

class _StreamNewMessageState extends State<StreamNewMessage> {
          ...
          children: <Widget>[
            Expanded(
              child: CustomTextField(
                ...
                text:
                    AppLocalizations.of(context)!.translate("type_new_message"),
